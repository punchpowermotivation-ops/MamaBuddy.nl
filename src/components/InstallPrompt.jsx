...
export default function InstallPrompt() {
  ...
  return (
    <div className="absolute left-3 right-3 bottom-[calc(94px+env(safe-area-inset-bottom))] z-40 bg-white border border-line rounded-2xl shadow-[0_10px_30px_rgba(30,26,24,.12)] px-4 py-3.5 flex items-center gap-3 animate-[fadeIn_.4s_ease]">
