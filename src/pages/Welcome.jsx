...
export default function Welcome() {
  ...
  if (step === 'sent') {
    return (
      <div className="min-h-svh bg-cream flex flex-col items-center justify-center text-center px-10">
  ...
  return (
    <div className="min-h-svh bg-gradient-to-br from-navy to-[#14110f] flex flex-col relative overflow-hidden">
