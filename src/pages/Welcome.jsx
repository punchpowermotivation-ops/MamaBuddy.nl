...
export default function Welcome() {
  ...
  if (step === 'sent') {
    return (
      <div className="app-shell overflow-y-auto bg-cream items-center justify-center text-center px-10 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
  ...
  return (
    <div className="app-shell overflow-y-auto bg-gradient-to-br from-navy to-[#14110f] relative pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
