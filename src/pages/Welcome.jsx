...
export default function Welcome() {
  ...
  if (step === 'email') {
    return (
      <div className="full-bleed-min-height bg-cream flex flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
  ...
  if (step === 'sent') {
    return (
      <div className="full-bleed-min-height bg-cream flex flex-col items-center justify-center text-center px-10 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
  ...
  return (
    <div className="full-bleed-min-height bg-gradient-to-br from-navy to-[#14110f] flex flex-col relative overflow-hidden pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
