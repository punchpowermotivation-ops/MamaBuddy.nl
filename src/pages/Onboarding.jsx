...
export default function Onboarding() {
  ...
  if (entered) {
    return (
      <div className="min-h-dvh bg-gradient-to-br from-navy to-[#14110f] flex flex-col items-center justify-center px-10 text-center pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
